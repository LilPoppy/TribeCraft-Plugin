					...
					if (args.length > 1) {
						if (args[1].equalsIgnoreCase("create")) {
							...
							if (args.length > 3) {
								...
								player.sendMessage("§6/triadmin gate create [传送门名] <传送类型[1,2,3]>");
								return false;
							}
							...
							if (args.length > 2) {
								...
								player.sendMessage("§6/triadmin gate remove [传送门名]");
								return false;
							}
							...
							player.sendMessage("§2传送门列表:" + sb.toString());
							return true;
							...
							if (args.length > 2) {
								if (TribeCraft.getPortalGateManager()
									...
									player.sendMessage("§2传送门名称: "
											+ gate.getName());
									player.sendMessage("§2传送类型: "
											+ gate.getType().name());
									player.sendMessage("§2传送提示: "
											+ gate.getMessage());
									player.sendMessage("§2传送出发点1: "
											+ "["
											+ "世界="
								...
								player.sendMessage("§6/triadmin gate check [传送门名]");
								return false;
							...
							if (args.length > 3) {
								...
								player.sendMessage("§6/triadmin gate message [传送门名] [提示信息]");
								return false;
							}
							...
							if (args.length > 4) {
								if (TribeCraft.getPortalGateManager()
									...
									if (args[3].equalsIgnoreCase("add")) {
										...
										player.sendMessage("§6/triadmin gate command [传送门名] [add/remove] [命令]");
										return false;
									}
								} else {
									player.sendMessage("§4"
							...
							if (args.length > 2) {
								...
								player.sendMessage("§6/triadmin gate location [传送门名]");
								return false;
							}
						} else {
