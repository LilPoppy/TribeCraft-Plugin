                ...
                if(args[0].equalsIgnoreCase("gate"))
                {
                    if(args.length > 1)
                    {
                        if(args[1].equalsIgnoreCase("create"))
                        {
                            ...
                            {
                                if(Area.isAreaOverlappingArea(new Area(TribeCraft.getPlayerManager().getPlayer(player.getName()).getGateSelectedLocation1(),TribeCraft.getPlayerManager().getPlayer(player.getName()).getGateSelectedLocation1()), gate.getFrom()))
                                {
                            ...
                            if(args.length > 3)
                            {
                                ...
                                if(ISystem.integer.isInt(args[3]))
                                {
                                    ...
                                    gate.setFrom(new Area(TribeCraft.getPlayerManager().getPlayer(player.getName()).getGateSelectedLocation1(),TribeCraft.getPlayerManager().getPlayer(player.getName()).getGateSelectedLocation2()));
                        ...
                        else if(args[1].equalsIgnoreCase("check"))
                        {
                            if(args.length > 2)
                            {
                                if(TribeCraft.getPortalGateManager().getPortalGate(args[2]) != null)
                                {
                                    ...
                                    player.sendMessage("传送出发点1: " + "[" + "世界=" + gate.getFrom().getLocation1().getWorld().getName() + "," + "x=" + gate.getFrom().getLocation1().getX() + "," + "y=" + gate.getFrom().getLocation1().getY() + "," + "z=" + gate.getFrom().getLocation1().getZ() + "]");
                                    player.sendMessage("传送出发点2: " + "[" + "世界=" + gate.getFrom().getLocation2().getWorld().getName() + "," + "x=" + gate.getFrom().getLocation2().getX() + "," + "y=" + gate.getFrom().getLocation2().getY() + "," + "z=" + gate.getFrom().getLocation2().getZ() + "]");
                                    player.sendMessage("传送目的地: " + (gate.getTo() == null ? "尚未设置" : "[" + "世界=" + gate.getTo().getWorld().getName() + "," + "x=" + gate.getTo().getX() + "," + "y=" + gate.getTo().getY() + "," + "z=" + gate.getTo().getZ() + "]"));
